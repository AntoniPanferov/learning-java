...
// Da der Inhalt null ist, wird ein leerer BinarySearchTree erzeugt.
    ...
    public void orderAusgabe(Order order, BinaryTree<ContentType> binaryTree) {
        switch (order) {
            case PREORDER:
                preOrder(binaryTree);
                break;
...
//                postOrder(binaryTree);
    ...
    private void preOrder(BinaryTree<ContentType> binaryTree) {
        if (getContent() != null) {
            System.out.println(binaryTree.getContent());
        }
    }
